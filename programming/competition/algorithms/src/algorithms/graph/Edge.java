...
/**
 * Edge class holds the information about the starting of the edge and ending of the edge. 
 * That means it holds from vertex and to vertex information. If this is a weighted graph,
 * then this also holds the weight information. This is a template based class can hold any
 * type of data. 
 * 
 * */
public class Edge<T> {
